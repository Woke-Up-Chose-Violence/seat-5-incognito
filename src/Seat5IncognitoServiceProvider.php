...
use WokeUpChoseViolence\Seat5Incognito\Commands\CorpMembersNotifications;
...
use WokeUpChoseViolence\Seat5Incognito\Commands\AllianceMembersAssets;
use WokeUpChoseViolence\Seat5Incognito\Commands\AllianceMembersLocations;
...
class Seat5IncognitoServiceProvider extends AbstractSeatPlugin
{
    ...
    private function add_commands()
    {
        $this->commands([
            ...
            CorpMembersNotifications::class,
            AllianceMembersLocations::class,
            AllianceMembersAssets::class,
        ]);
    }
